...
Light::Light() : Unit(glm::mat4(1.f)), Change(glm::mat4(1.f)),
	BoxColor(glm::vec3(0.8, 0.8, 0.8)), LightColor(glm::vec3(1.f)), distance(10.f)
{
}
...
void Light::Update()
{
	...
	glm::mat4 Trans = glm::translate(Unit, glm::vec3(distance, 1, 0));
...
void Light::Draw()
{
	glm::vec3 lightPos(distance - 0.5f, 0, 0);
	...
	glUniform4f(objColorLocation, BoxColor.r, BoxColor.g, BoxColor.b, 1.0);
